...
send_email("Важное сообщение", "test@example.com", sender="support@company.com")
send_email("Ошибка", "university.help@gmail.com", sender="university.help@gmail.com")
send_email("Запрос", "wrong.address", sender="unknown@wrong.domain")
