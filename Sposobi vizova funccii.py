...
Внутри функции реализовать следующую логи"ку:
...
def send_email(message, recipient, sender = "university.help@gmail.com"): # Создала функцию с двумя обычными аргуменатми и одни обязательным со значением по умолчанию.
...
send_email("КАк дел","testexample.com" )
send_email("Привет!", "test@example.com")
send_email("Важное сообщение", "test@example.com","support@company.com")
send_email("Ошибка", "university.help@gmail.com","university.help@gmail.com")
send_email("Запрос", "wrong.address", "unknown@wrong.domain")
